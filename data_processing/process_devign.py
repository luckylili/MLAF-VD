...
file_name = '../data/devign_with_slices.json'
...
print(len(data))
print('void prplcb_conv_del_users ( PurpleConversation * conv , GList * cbuddies ) {\n  struct groupchat * gc = conv -> ui_data ;\n  GList * b ;\n  for ( b = cbuddies ;\n  b ;\n  b = b -> next ) {\n  imcb_chat_remove_buddy ( gc , b -> data , "" ) ;\n  }\n  }'.split('\n'))
...
at_least_one = set()
vuld_taken = set()
all_indices = set(list(range(len(data))))
left_out = set()
...
print('Total: \t%d\nVulDee:\t%d\nSY API:\t%d\nSY Arr:\t%d\nSY Ari:\t%d\nSY Ptr:\t%d' % (len(data), vd_num, call_num, array_num, arith_num, ptr_num))

print(len(at_least_one))
left_out = all_indices.difference(at_least_one)
