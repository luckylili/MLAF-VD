...
class ExtendedModel(nn.Module):  
    def __init__(self, arg, encoder, roberta_config, gat_heads, gat_in_channels_cfg, gat_in_channels_dfg, gat_in_channels_dsg, gat_out_channels, hidden_dims, output_dim, weights):  
        ...
        self.class_weights = torch.FloatTensor(weights).to(arg.device)
...
class CodeGraphDataset(Dataset):  
    ...
    def __getitem__(self, idx):  
        while True:
            ...
            idx = random.choice(possible_indices)+1
